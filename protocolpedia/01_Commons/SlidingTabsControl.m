                   ...
                   delegate:(NSObject <SlidingTabsControlDelegate>*)slidingTabsControlDelegate 
{
    if ((self = [super init]))
    {
        ...
        self.backgroundColor = [UIColor colorWithRed:36.0/255 green:36.0/255 blue:36.0/255 alpha:1.0];
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int i = 0; i < [_buttons count]; i++) {
        ...
        CGContextAddLineToPoint(context, buttonWidth * i, 50.0);
